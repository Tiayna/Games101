...
bool rayTriangleIntersect(const Vector3f& v0, const Vector3f& v1, const Vector3f& v2, const Vector3f& orig,   //Moller Trumbore Algorithm
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    // TODO: Implement this function that tests whether the triangle
    // that's specified bt v0, v1 and v2 intersects with the ray (whose
    // origin is *orig* and direction is *dir*)
    // Also don't forget to update tnear, u and v.   tnear = t , u = b1 , v = b2
    ...
    if(t>=0.0 && b1>=0.0 && b2>=0.0 && (1-b1-b2)>=0)     //(1-b1-b2)>= -__FLT_EPSILON__
    {
        tnear = t;
        u = b1;
        v = b2;
